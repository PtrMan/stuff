...
class Lexer
{
   ...
   this()
   {
      ...
      /*  10 inside "..." */new TableElement(true ,    1, false, 10), new TableElement(true ,  1, false, 10), new TableElement(true , 1, false, 10), new TableElement(true , 1, false, 10), new TableElement(true , 1, false, 10), new TableElement(true , 1, false, 10), new TableElement(true , 1, false, 10), new TableElement(true , 1, false, 10), new TableElement(true , 0, true ,  0), new TableElement(true , 0, false, 12),
